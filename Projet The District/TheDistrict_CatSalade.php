        ...
        <div class="container">
          <div class="row justify-content-around g-0">
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="images_the_district/food/Salade/SaladeAvocatBetterave.jpg" class="card-img border border-secondary border-5" alt="...">
            ...
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="images_the_district/food/Salade/SaladeCesar.jpg" class="card-img border border-secondary border-5" alt="...">
            ...
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="images_the_district/food/Salade/SaladeCrevette.jpg" class="card-img border border-secondary border-5" alt="...">
            ...
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="images_the_district/food/Salade/SaladeGrec.jpg" class="card-img border border-secondary border-5" alt="...">
        ...
        <section>
          <div class="container">
            <div class="row justify-content-around g-0">
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="images_the_district/food/Salade/SaladePDT.jpg" class="card-img border border-secondary border-5" alt="...">
              ...
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="images_the_district/food/Salade/SaladePestoPasta.jpg" class="card-img border border-secondary border-5" alt="...">
              ...
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="images_the_district/food/Salade/SaladeRiz.jpg" class="card-img border border-secondary border-5" alt="...">
              ...
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="images_the_district/food/Salade/Taboulet.jpg" class="card-img border border-secondary border-5" alt="...">
