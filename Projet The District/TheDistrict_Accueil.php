...
<html lang="fr">
    <head>
        ...
        <link rel="stylesheet" href="TheDistrict_Accueil.css">
    </head>
    <body id="body">
      <div class="container">
        <?php
        ...
        <section class="row">
          <div>
            ...
            <video autoplay muted loop id="video"> 
              <source src="images_the_district/Image_ajouté/BugerCut.mp4" type="video/mp4">
            </video>
            ...
            <div class="carousel-item active">
              <div class="container">
                <div id="plataccueil" class="row">
                  <span class="col-3">
                  <div id="plat1">
                    <img src="images_the_district/food/Asian food/poulet-aigre-douce.png" width="280px" height="180px" id="plat01">
                    <p>Plat 1</p>
                  </div>
                  </span>
                  <span class="col-3">
                  <div id="plat2">
                    <img src="images_the_district/food/Boulangerie/PainBanane.jpg" width="280px" height="180px" id="plat02">
                    <p>Plat 2</p>
                  </div>
                </span>
                <span class="col-3">
                  <div id="plat3">
                    <img src="images_the_district/food/Burger/burger2.png" width="280px" height="180px"  id="plat03">
                    <p>Plat 3</p>
                  </div>
                </span>
                </div>
            ...
            <div class="carousel-item">
              <div class="container">
                <div id="plataccueil" class="row">
                  <span class="col-3">
                  <div id="plat1">
                    <img src="images_the_district/food/Dessert/TarteletteCitron.jpg" width="280px" height="180px" id="plat01">
                    <p>Plat 4</p>
                  </div>
                  </span>
                  <span class="col-3">
                  <div id="plat2">
                    <img src="images_the_district/food/Fromage/Mozza.jpg" width="280px" height="180px" id="plat02">
                    <p>Plat 5</p>
                  </div>
                </span>
                <span class="col-3">
                  <div id="plat3">
                    <img src="images_the_district/food/Pasta/SpaghettiBolo.jpg" width="280px" height="180px"  id="plat03">
                    <p>Plat 6</p>
                  </div>
                </span>
                </div>
            ...
            <div class="carousel-item">
              <div class="container">
                <div id="plataccueil" class="row">
                  <span class="col-3">
                  <div id="plat1">
                    <img src="images_the_district/food/Pizza/calzone.jpg" width="280px" height="180px" id="plat01">
                    <p>Plat 7</p>
                  </div>
                  </span>
                  <span class="col-3">
                  <div id="plat2">
                    <img src="images_the_district/food/Plat Traditionelle/BoeufBourguignon.jpg" width="280px" height="180px" id="plat02">
                    <p>Plat 8</p>
                  </div>
                </span>
                <span class="col-3">
                  <div id="plat3">
                    <img src="images_the_district/food/Salade/SaladeCesar.jpg" width="280px" height="180px"  id="plat03">
                    <p>Plat 9</p>
                  </div>
                </span>
                </div>
            ...
            <div class="carousel-item">
              <div class="container">
                <div id="plataccueil" class="row">
                  <span class="col-3">
                  <div id="plat1">
                    <img src="images_the_district/food/Snack/CroqueMadame.jpg" width="280px" height="180px" id="plat01">
                    <p>Plat 10</p>
                  </div>
                  </span>
                  <span class="col-3">
                  <div id="plat2">
                    <img src="images_the_district/food/Veggie/CouscousVeggie.jpg" width="280px" height="180px" id="plat02">
                    <p>Plat 11</p>
                  </div>
                </span>
                <span class="col-3">
                  <div id="plat3">
                    <img src="images_the_district/food/Wrap/WrapBuffaloChiken.jpg" width="280px" height="180px"  id="plat03">
                    <p>Plat 12</p>
                  </div>
                </span>
                </div>
