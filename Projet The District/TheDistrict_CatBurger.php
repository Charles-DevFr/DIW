        ...
        <div class="container">
          <div class="row justify-content-around g-0">
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="images_the_district/food/Burger/burger1.png" class="card-img border border-secondary border-5" alt="...">
            ...
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="images_the_district/food/Burger/burger2.png" class="card-img border border-secondary border-5" alt="...">
            ...
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="images_the_district/food/Burger/burger3.png" class="card-img border border-secondary border-5" alt="...">
            ...
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="images_the_district/food/Burger/burger4.png" class="card-img border border-secondary border-5" alt="...">
        ...
        <section>
          <div class="container">
            <div class="row justify-content-around g-0">
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="images_the_district/food/Burger/burger5.png" class="card-img border border-secondary border-5" alt="...">
              ...
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="images_the_district/food/Burger/burger6.png" class="card-img border border-secondary border-5" alt="...">
              ...
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="images_the_district/food/Burger/burger7.png" class="card-img border border-secondary border-5" alt="...">
              ...
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="images_the_district/food/Burger/burger8.png" class="card-img border border-secondary border-5" alt="...">
