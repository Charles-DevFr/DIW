        ...
        <div class="container">
          <div class="row justify-content-around g-0">
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="images_the_district/food/Wrap/WrapBaconAvocat.jpg" class="card-img border border-secondary border-5" alt="...">
            ...
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="images_the_district/food/Wrap/WrapBoeuf.jpg" class="card-img border border-secondary border-5" alt="...">
            ...
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="images_the_district/food/Wrap/WrapBuffaloChiken.jpg" class="card-img border border-secondary border-5" alt="...">
            ...
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="images_the_district/food/Wrap/WrapLegume.jpg" class="card-img border border-secondary border-5" alt="...">
        ...
        <section>
          <div class="container">
            <div class="row justify-content-around g-0">
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="images_the_district/food/Wrap/WrapPoisson.jpg" class="card-img border border-secondary border-5" alt="...">
              ...
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="images_the_district/food/Wrap/WrapPouletAvocat.jpg" class="card-img border border-secondary border-5" alt="...">
              ...
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="images_the_district/food/Wrap/WrapPouletCrudite.jpg" class="card-img border border-secondary border-5" alt="...">
              ...
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="images_the_district/food/Wrap/WrapSaumonConcombre.jpg" class="card-img border border-secondary border-5" alt="...">
